...
import { getDraftImageDimensions } from "@/modules/shared/utils";
...
export function ChatComposer({
  ...
  const { width: previewWidth, height: previewHeight } = getDraftImageDimensions(
    activePreset.width,
    activePreset.height,
  );
          ...
          <div className="mt-2">
            <div className="flex items-center justify-center gap-1">
              ...
              <button
                ...
                disabled={disabled}
                title={previewMode ? "Draft mode on - SDXL-safe reduced resolution" : "Enable draft mode for faster preview"}
                className={cn(
                  "px-2.5 py-0.5 rounded-md text-xs transition-colors outline-none",
                  previewMode
