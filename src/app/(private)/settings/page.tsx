...
import { PluginManager } from "@/modules/plugins/components/PluginManager";
        ...
        <div className="max-w-2xl mx-auto px-4 py-6 space-y-4">
          ...
          <SettingsSection title="Image Generation">
            <SettingsToggle
              ...
              description="Resolve your message in the context of the conversation before generating"
              defaultChecked={bool("contextAwarePrompts", true)}
              settingKey="contextAwarePrompts"
            />
            <SettingsToggle
            ...
            />
            <SettingsToggle
              label="Translate prompts to Chinese (Simplified)"
              description="Translate the final prompt to Chinese before generating. Text in quotes is preserved."
              defaultChecked={bool("translatePromptToChinese")}
              settingKey="translatePromptToChinese"
            />
          </SettingsSection>
